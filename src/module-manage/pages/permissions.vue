    ...
    <div class="app-container">
      ...
      <el-card class="box-card">
        ...
        <el-row :gutter="20">
          <el-col :span="18">
            <el-row :gutter="20">
              <el-col :span="8"> <el-input v-model="queryInfo.title" placeholder="根据用户名搜索"></el-input> </el-col>
              <el-col :span="6">
                <el-button class="btnpermissionr" size="small" plain @click="emptypermissions">清空</el-button>
                <el-button class="btnpermissionr" size="small" type="primary" plain @click="searchpermissions">搜索</el-button>
              </el-col>
            </el-row>
          </el-col>
          <el-col :span="6">
            <el-button type="success" icon="el-icon-edit" @click="addpermissions">新增权限组</el-button>
          </el-col>
        </el-row>
        <!-- 提示信息部分 -->
        <el-alert :title="countstext" type="info" show-icon :closable="false"></el-alert>
        <!-- 表格部分 -->
        <el-table v-loading="loading" element-loading-text="给我一点时间" :data="permissionsTableData" style="width: 100%">
          <el-table-column type="selection"> </el-table-column>
          <el-table-column align="right" prop="title" label="用户名"></el-table-column>
          <el-table-column align="right" prop="update_date" label="日期" sortable></el-table-column>
          <el-table-column align="right" label="操作">
            <template slot-scope="scope">
              <!-- 编辑按钮 -->
              <el-button plain type="primary" icon="el-icon-edit" circle @click="showedit(scope.row)"></el-button>
              <!-- 删除按钮 -->
              <el-button plain type="danger" icon="el-icon-delete" circle @click="removeById(scope.row)"></el-button>
            </template>
          </el-table-column>
        </el-table>
      ...
      <!-- 新增权限 -->
      <el-dialog title="创建权限组" :visible.sync="addDialogVisible" width="50%" @close="closeadd">
        <el-form :model="addForm" :rules="addFormRules" ref="addFormRef" label-width="100px" class="demo-ruleForm" style="width: 400px; margin-left:120px;">
      ...
      <!-- 编辑弹框 -->
      <el-dialog title="编辑权限组" :visible.sync="editDialogVisible" width="50%" @close="closeedit">
        <el-form :model="editForm" :rules="editFormRules" ref="editFormRef" label-width="100px" class="demo-ruleForm" style="width: 400px; margin-left:120px;">
          <el-form-item label="用户名" prop="title">
...
export default {
  ...
  methods: {
    ...
    async getTreeInfo (row) {
      ...
      // this.defkeys默认选中项的id 包含__ob__: Observer].无法识别
    },
    // 点击编辑获取数据
    async showedit (row) {
      try {
